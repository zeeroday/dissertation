...
discussed.
\section{Adoptation de SDG in progress}


\section{Qu-est ce que la platforme a apporte et ce que nous on a apporte}
\section{Comparaison avec other platform}
\section{ Explication about the summer school, experience, different way to document etc..} 
\section{When we can use it and how we can use it ?} 
\section{} 
\section{} 
\section{} 
\section{} 
...
The idea of sustainable technology developement is motivated by my experience participating in many hackathons in Switzerland then doing a The Geneva Tshingua summer school and my master courses experiences.

People in hackathons gather themselves together, generate new ideas, develop its concept and get it prototyped. The same thing happen in a summer school, workshops etc.. Most ideas die for many reason, the most common reson is aout the documentation of these ideas in a way where we could have a track of the project and a visual documentation for the steps in a way where anyone could go through the steps, learn about the project and continue it.
